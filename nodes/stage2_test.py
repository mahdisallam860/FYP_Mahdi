...
class Stage2Tester:
    def __init__(self):
        rospy.init_node('stage2_tester', anonymous=True)

        # Directories for results
        self.results_dir = "/home/alma/catkin_ws/src/dqn3results/stage2"
        os.makedirs(self.results_dir, exist_ok=True)

        # Define test goals
 # Replace self.test_goals with the following:
        self.test_goals = [
        (1.5, 1.5),    # Between outer and inner obstacles - requires precise navigation
        (-1.5, -1.5),  # Opposite corner, also between obstacles
        (0.0, 2.8),    # Near the wall, between obstacles at (0,2) - tests wall following
        (2.8, 0.0)     # Mirror of previous, different approach needed
    ]
...
if __name__ == "__main__":
    try:
        tester = Stage2Tester()
        ddqn_model_path = "/home/alma/catkin_ws/sc/dqn3/models/stage1_enhanced/model_ep1100_20250104_195513.pth"  # Update with actual path  # Update with actual path
        dqn_model_path = "/home/alma/catkin_ws/src/dqn3/models/stage2_enhanced/model_ep1100_20250105_161824.pth"    # Replace with your DQN model path
